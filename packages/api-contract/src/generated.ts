...
export interface components {
    schemas: {
        ...
        ApiError: components["schemas"]["ApiMeta"] & {
            /** @enum {string} */
            code: "COMMON_INTERNAL_SERVER_ERROR" | "AUTH_INVALID_TOKEN" | "SETTINGS_VALIDATION_FAILED" | "SSH_VALIDATION_FAILED" | "SSH_SERVER_CONFLICT" | "SSH_FOLDER_CONFLICT" | "SSH_TAG_CONFLICT" | "SSH_NOT_FOUND" | "SSH_HOST_UNTRUSTED" | "SSH_SESSION_NOT_FOUND";
            /** @enum {boolean} */
            success: false;
        };
        /** @enum {string} */
