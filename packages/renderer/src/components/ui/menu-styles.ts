export const menuStyles = {
  content:
    'z-50 min-w-[180px] max-h-[min(560px,calc(100vh-16px))] max-w-[calc(100vw-16px)] overflow-y-auto rounded-[14px] bg-bg-subtle p-[4px] text-sm text-header-text shadow-menu-content backdrop-blur-[4px] [-webkit-app-region:no-drag]',
  contentCloseMotion:
