export const menuStyles = {
  ...
  separator: 'bg-menu-divider my-1 ml-9 mr-2.5 h-px',
  ...
  control:
    'menu-menubar-control inline-flex h-[34px] items-center gap-2 rounded-[14px] bg-menu-control px-2.5 text-sm text-header-text outline-none shadow-soft backdrop-blur-[4px] hover:bg-menu-control-hover data-[state=open]:bg-menu-control-hover data-[state=on]:bg-menu-control-hover [-webkit-app-region:no-drag]',
  menubarRoot:
    'menu-menubar-root inline-flex h-[42px] items-center rounded-[18px] bg-menu-control p-[4px] shadow-soft backdrop-blur-[4px] [&>.menu-menubar-separator]:bg-menu-divider [-webkit-app-region:no-drag]',
  menubarTrigger:
  ...
  toggleGroupRoot:
    'menu-toggle-group-root inline-flex h-[42px] items-center rounded-[18px] bg-menu-control p-[4px] shadow-soft backdrop-blur-[4px] [-webkit-app-region:no-drag]',
  toggleGroupItem:
