...
| `app:get-version-info` | `invoke` | none | `Promise<{ appName: string; version: string; buildVersion: string; buildTime: string }>` | Returns app display name, version, internal build version, and build time for About page |
